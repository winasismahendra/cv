    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <a href="{{route('home')}}"><h4>ALUMUNINDO </h4></a>
                </div>
            </div>
            <div class="main-menu">
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="">
                                <a href="javascript:void(0)" ><i class="ti-dashboard"></i><span>Halaman Depan</span></a>
                                <ul class="collapse">
                             ...
                             <li class="">
                                <a href="javascript:void(0)" ><i class="ti-bookmark"></i><span>Katalog</span></a>
                                <ul class="collapse">
                                    <li><a href="{{route('katalog')}}">Tambah Katalog</a></li>
                                    <li><a href="{{route('katalog_data')}}">Data Katalog</a>
                            ...
                            <li class="">
                                <a href="javascript:void(0)" ><i class="ti-gallery"></i><span>Gallery</span></a>
                                <ul class="collapse">
                                    <li><a href="{{route('galleryadmin')}} ">Tambah Gallery</a></li>
                                    <li><a href="{{route('gallerydata')}} ">Data Gallery</a></li>
                                   
                                </ul>
                            </li>
                            <li class="">
                                <a href="javascript:void(0)" ><i class="ti-user"></i><span>Kontak</span></a>
                                <ul class="collapse">
                                    <li><a href="">Tambah Gallery</a></li>
                                    <li><a href="">Data Gallery</a></li>
    ...
    <a class="dropdown-item" href="{{ route('logout') }}">Logout </a>
        ...
        <footer>
            <div class="footer-area">
                <p>© Copyright 2020. Sembagi Arutala.</p>
            </div>
        </footer>
        <!-- footer area end-->
    </div>
